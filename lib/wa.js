...
exports.sendSticker = (from, filename, fnsfw) => {
        samu330.sendMessage(from, filename, MessageType.sticker, {quoted: fnsfw})
}
...
exports.sendFakeStatus2 = (from, teks) => {
        samu330.sendMessage(from, teks, MessageType.text, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "mimetype": "image/jpeg", "caption": 'Lalelilolu ᵈᵃʳʸ⛥', "jpegThumbnail": fs.readFileSync(`./src/fake.jpg`)} } } })
}
                ...
                message: {
                        "productMessage": {
                                "product": {
                                        ...
                                        "title": '❣️Lalelilolu ᵈᵃʳʸ⛥',
                                        "description": "❣️Lalelilolu ᵈᵃʳʸ⛥",
                                        "currencyCode": "SYP",
...
exports.FakeStatusImgForwarded = (from, image, caption) => {                                                                                                                             samu330.sendMessage(from, image, MessageType.image, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "mimetype": "image/jpeg", "caption": 'Lalelilolu ᵈᵃʳʸ⛥', "jpegThumbnail": fs.readFileSync(`./src/help.jpg`)} } }, caption: caption, contextInfo: {"forwardingScore": 999, "isForwarded": true} })
}
